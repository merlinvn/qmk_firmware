 ...
 */
  [_NAVIGATION] = LAYOUT(\
      ...
      SW_WIN, SW_TAB, KC_DEL, KC_TAB, KC_APP,                           KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_INS,
              KC_NO, KC_NO,                                                              KC_NO, KC_NO,
  ...
  [_NUMBERS]    = LAYOUT(\
      ...
      KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, KC_NO,                     KC_PLUS, KC_4, KC_5, KC_6, KC_EQL,
      KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                             KC_MINS, KC_1, KC_2, KC_3, KC_DOT,
                KC_NO, KC_NO,                                                   KC_NO, KC_NO,
 ...
 */
  [_FN] = LAYOUT(\
      ...
      KC_F12, KC_F1, KC_F2, KC_F3, KC_PAUS,                          KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
              KC_NO, KC_NO,                                                         KC_NO, KC_NO,
                        KC_ESC, KC_APP,                          KC_NO, KC_TRNS,
                                    KC_NO, KC_NO,            KC_NO, KC_NO,
                                    KC_NO, KC_NO,             KC_NO, KC_NO
  )};
